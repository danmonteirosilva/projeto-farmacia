...
class Balconista(models.Model):
    ...
    numero = models.IntegerField(max_length=7, blank=False, null=False, verbose_name='Nº')
    ...
    estado = models.CharField(max_length=100, null=False, blank=False, verbose_name='Estado')
    telefone = models.IntegerField(max_length=15,blank=False, null=False, verbose_name='Telefone')
